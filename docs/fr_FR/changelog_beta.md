...
- Nouveautés :
  ...
  - Changement de la structure de données des éléments (et nettoyage du code). Attention si vous avez des blocs code et fait des changements vous même il se peut que certaines choses ne fonctionnent plus...
